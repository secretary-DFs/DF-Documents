...
\paragraph{} Committee shall be composed of twelve or thirteen (see \ref{sec:treasurerrole}) electable positions (or `primary roles').

\paragraph{} The term of a primary role shall be two years, with the exceptions of the Treasurer and Shadow Treasurer, and subject to the details outlined in \ref{sec:rolereplacement}.
...
\item Shadow Treasurer (If this is applicable according to the rules set out in \autoref{sec:treasurerrole})
...
\label{sec:election}
\subsubsection{}
Elections for primary roles on Committee (with the exception of Chair of Regional Council) shall be held at Althing (see section \ref{sec:althing}), and nominations be may made up until the point at which hustings for the positions begins.

\subsubsection{}
The Chair of Regional Council will be elected for a term of one year from and by Regional Council by AV (as set out in the Democratic Procedures) at Old/New (see \ref{sec:rcchair}).
...
\subsection{Old/New}
\label{sec:oldnew}
\subsubsection{} Annually, not more than two months after Althing, DF Committee and Regional Council shall hold a closed meeting called `Old/New'.

\subsubsection{} The business of Old/New will include the election of secondary roles (see \ref{sec:secondaryroles}).

\subsubsection{} Additionally, two members shall be elected at Old/New from DF Committee and Regional Council combinded to represent the Movement on the Woodcraft Folk's General Council for one year.
